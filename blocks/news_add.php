        ...
        <form method="post" action="function/news_add_script.php" class="form_bg">
            <div class="row mb-2">
                <div class="col">
                    ...
                    <input name="news_header" class="form-control" placeholder="Введите заголовок" type="text"
                           required/>
                </div>
                <div class="col">
                    ...
                    <input name="news_date" class="datetime-local form-control" id="date_1" type="datetime-local"
                           required/>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col">
                    ...
                    <textarea name="news_text" class="form-control" id="exampleFormControlTextarea1" rows="3"
                              required></textarea>
                </div>
            </div>
            <div class="row mb-2">
