                    ...
                    if ($_SESSION['roles_id'] == 2) {
                        ...
                        <div class="row">
                            <div class="col text-center">
                                <button class="btn bg-button my-2 my-sm-0" type="submit" name="btn_change_status">
                                    Сохранить
                                </button>
                    ...
                    <div class="col-md-12 px-lg-auto px-0">
                        <div class="chat-message">
                                        ...
                                        <div class="chat-body white ml-2 z-depth-1">
                                            <div class="header">
                                                ...
                                                <small class="pull-right text-muted"><i
                                                            class="far fa-clock"></i> <?= $comment["app_comments_datetime"] ?>
                                                </small>
                                            </div>
                                            <hr class="w-100">
                                            <p class="mb-0">
                            ...
                            <form action="" method="post">
                                ...
                                <!-- Кнопка отправки -->
                                <button type="button0" name="new_comments" class="btn bg-button float-right"
