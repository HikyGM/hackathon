<section class="pb-10 pt-0 blog-articles bg-color--primary-light--1" style="margin-top: 5em; padding-top: 2em; background: #E3E3E3;">
    <div class="container" style="padding-top: 1em">
        ...
        <div class="row row-cols-1 row-cols-md-3">
                    ...
                    $sql = "SELECT a.application_id, u.users_fio, a.application_status, a.application_datetime FROM `applications` a, users u where a.users_id = u.users_id and a.application_id = '".$_REQUEST['id']."'";
                    print($sql);
